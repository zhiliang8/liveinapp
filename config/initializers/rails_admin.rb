# RailsAdmin config file. Generated on December 03, 2011 14:03
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Liveinapp', 'Admin']
  ...
  # config.excluded_models = [Node, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Node, User]
  ...
  #     configure :parent, :belongs_to_association   #   # Found columns:
